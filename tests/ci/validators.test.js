...
function runTests() {
  ...
  if (test('syncs tracked catalog docs in write mode without rewriting unrelated tables', () => {
    ...
    assert.ok(readme.includes('| **Agents** | 1 | Shared (AGENTS.md) | 1 packaged + 3 project roles | 1 generated local/extension agents | 12 | N/A |'), 'Should sync README parity table');
